...
export async function getOAuthHeader(token: Token, endpoint: string, method: string) {
 ...
 */
export async function postRequest(token: Token, endpoint: string, data: unknown): Promise<any> {
